...
setwd("/Users/allisonlouthan/Dropbox/climate across latitudes/IDE/code/")

# load in data----

# load terrestial map area from: https://www.naturalearthdata.com/downloads/10m-physical-vectors/10m-land/
terrestrial_sf <- sf::st_read("data/ne_10m_land/ne_10m_land.shp") 
# NB: this warning: although coordinates are longitude/latitude, st_intersection assumes that they are planar can be ignored, because your work is global
